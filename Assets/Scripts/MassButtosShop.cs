...
public class MassButtosShop : MonoBehaviour
{
    ...
    //private void Start()
    //{
    //    for (int i = 0; i < MassButtonClickStart.Count; i++)
    //        AddButtonInMassClick();

    //    for (int i = 0; i < MassButtonClickStart.Count; i++)
    //        AddButtonInMassAuto();
    //}

    //void AddButtonInMassClick()
    //{

    //}

    //void AddButtonInMassAuto()
    //{
